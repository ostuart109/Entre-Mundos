...
{
	//Setando a camera
	camera_set_view_size(view_camera[1], global.view_width, global.view_height) ;
	...
	if (instance_exists(view_target))
	{
		...
		//Posição da Camera
		camera_set_view_pos(view_camera[1], clamp(_x1, c_x, _x1), clamp(_y1, c_y, _y1)) ;
	}	
}
